...
export default async function AdminPage() {
  ...
  try {
    const { customers, invoices, returns, stockByCategory } = await getBillingDashboardData()
    return <AdminDashboard customers={customers} invoices={invoices} returns={returns} stockByCategory={stockByCategory} />
  } catch (error) {
